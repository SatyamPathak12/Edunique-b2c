...
export default function SchoolManagementReportPage() {
  ...
  return (
    <div>
      ...
      <div className="p-4">
        <MaxWidthWrapper className="bg-white rounded-2xl py-4  overflow-hidden">
          <div className="flex items-center justify-start overflow-x-auto no-scrollbar gap-8 mb-4 font-medium">
            {tabs.map((tab, indx) => (
              <Link href={tabPaths[tab]} key={indx}>
                <button
                  ...
                  className={cn(
                    "text-[#6B7280] cursor-pointer bg-transparent border-none outline-none inline-block",
                    selectedTab === tab &&
    ...
    >
      <div className="border p-4 rounded-2xl w-full">
        ...
        <div className="bg-[#D3F5FF] rounded-2xl px-4 py-2">
          <h1 className="text-[#1D5851] font-bold">
