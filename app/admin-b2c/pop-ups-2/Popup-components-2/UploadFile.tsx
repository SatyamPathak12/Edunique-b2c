...
export const UploadFile: React.FC<PopupProp> = ({
    isOpen,
    onClose,
}) => {
    return (
        <BaseModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-md">
            <div className="rounded-3xl px-4 pt-6 pb-4 ">
                <div className="flex justify-between items-center">
                    <h2 className="text-xl font-semibold">Upload Content File</h2>
                    <button
                        onClick={onClose}
            ...
            <div className="flex justify-end gap-2 items-center">
                <button className="bg-[#f9fafb] rounded-full py-2.5 px-4 text-gray-500">Cancel</button>
                <button className="bg-[#3366ff] rounded-full py-2.5 px-4 text-white">Continue</button>
            </div>
        </BaseModal>
    );
};