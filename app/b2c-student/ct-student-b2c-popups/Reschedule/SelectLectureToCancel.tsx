...
const SelectLectureToCancel: React.FC<PopupPropB2CStudent> = ({ isOpen, onClose }) => {
    ...
    <StudentB2CBaseModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-4xl">
      <div className="overflow-x-auto px-4 py-6 text-sm min-w-[800px]">
        <div className="flex justify-between items-center w-full">
          <h2 className="text-2xl font-semibold mb-4">Select Lecture to Cancel</h2>
          <MonthTab />
        </div>
        {/* Header */}
      ...
      <div className="flex justify-center items-center gap-4 pt-2 pb-3">
        <button onClick={onClose} className="max-w-32 font-medium w-full rounded-full text-gray-600 bg-[#e3e3e3] py-2.5">Discard</button>
...
export default SelectLectureToCancel;
