...
import SelectionCard from "@/app/b2c-teacher/new-pop-ups/popupComponent/select-type"
...
export default function StudentNavbar({ activeState = "Home", isLanding = false }: { activeState?: string, isLanding?: boolean }) {
  ...
  const navLinks = [
    "/b2c-teacher/teacher-flow/home",
    "/b2c-teacher/teacher-flow/about-us",
    "/b2c-teacher/teacher-flow/educator",
    "/b2c-teacher/teacher-flow/courses",
    "/b2c-teacher/teacher-flow/contact",
    "/b2c-teacher/teacher-flow/dashboard",
  ];
